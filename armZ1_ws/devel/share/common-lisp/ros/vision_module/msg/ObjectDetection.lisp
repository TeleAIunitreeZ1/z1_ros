...
(cl:in-package vision_module-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vision_module-msg:<ObjectDetection> is deprecated: use vision_module-msg:ObjectDetection instead.")))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision_module-msg:label-val is deprecated.  Use vision_module-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision_module-msg:x-val is deprecated.  Use vision_module-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision_module-msg:y-val is deprecated.  Use vision_module-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision_module-msg:depth-val is deprecated.  Use vision_module-msg:depth instead.")
  (depth m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObjectDetection>)))
  ...
  "6c811d8df461a90868e78656a89fbe92")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObjectDetection)))
  "Returns md5sum for a message object of type 'ObjectDetection"
  "6c811d8df461a90868e78656a89fbe92")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjectDetection>)))
  ...
  (cl:format cl:nil "# ObjectDetection.msg~%string label~%float32 x~%float32 y~%float32 depth~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjectDetection)))
  "Returns full string definition for message of type 'ObjectDetection"
  (cl:format cl:nil "# ObjectDetection.msg~%string label~%float32 x~%float32 y~%float32 depth~%~%~%~%"))
