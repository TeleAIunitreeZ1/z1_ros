...
def pixeltobase(u,v,d):
    ...
    #                             [ 0, 0, 0, 1]])    
    # 原
    # matrixHand2Camera = np.array([[0.01064262, 0.00664979, 0.99992125,0.11366066],
    #                             [-0.99979937, 0.01704032, 0.010528, 0.0346484 ],
    #                             [-0.01696897, -0.99983269, 0.00682981, -0.06288242],
    #                             [ 0, 0, 0, 1 ]])
    ...
    effector_pos[4] = effector_pos[4]  + 0.02  #y轴右减左加
