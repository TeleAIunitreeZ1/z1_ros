...
def on_open(ws):
    def run(*args):
        ...
        # resample_audio(wsParam.AudioFile, "audio_16000.pcm", target_rate=16000) #降低音频频率
...
wsParam_test = Ws_Param(APPID='f879c9a6', APISecret='NzY3ZGQwZGViODc5ZmY1NzMxYmY4NmM1',
                    APIKey='d1faf503ef453239e49690582b14a87f',
                    AudioFile=r'audio.pcm')