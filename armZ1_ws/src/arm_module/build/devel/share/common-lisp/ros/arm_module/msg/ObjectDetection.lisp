...
(cl:defmethod cl:initialize-instance :after ((m <ObjectDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_module-msg:<ObjectDetection> is deprecated: use arm_module-msg:ObjectDetection instead.")))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_module-msg:label-val is deprecated.  Use arm_module-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_module-msg:x-val is deprecated.  Use arm_module-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_module-msg:y-val is deprecated.  Use arm_module-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_module-msg:depth-val is deprecated.  Use arm_module-msg:depth instead.")
  (depth m))
